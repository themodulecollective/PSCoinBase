#
# Module manifest for module 'InstallManager'
#
...
@{
    ...
    Description          = 'a PowerShell Module for connecting to and using Coinbase APIs.'
    ...
    FunctionsToExport    = @(
        ...
        'Get-CoinbaseAccountTransaction'
        'Get-CoinbaseAccountWithdrawal'
        'Get-CoinbaseAddress'
        'Get-CoinbaseAddressTransaction'
        'Get-CoinbaseBuy'
        'Get-CoinbaseCurrency'
        'Get-CoinbaseCurrentUserAuth'
        'Get-CoinbaseExchangeRate'
        'Get-CoinbasePaymentMethod'
        'Get-CoinbasePrice'
        'Get-CoinbaseUser'
    )
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/themodulecollective/InstallManager'
